Public Class frmWestEndOrderx
    ...
    Private Sub ComputeCurrentSelection()
        If radRibeyeSandwich.Checked Then
            ...
            Dim RibeyeSandwichItem As String = _
        ...
        If chkFries.Checked Then
            ...
            Dim FrenchFriesItem As String = _
        ...
        If chkMozzSticks.Checked Then
            ...
            Dim MozzSticksItem As String = _
